...
function AppShell() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 bg-mesh-light font-sans text-slate-900 antialiased dark:bg-slate-950 dark:text-slate-100">
          ...
          <Route
            ...
            element={
              <div className="flex min-h-[50vh] flex-col items-center justify-center px-4 py-20 text-center">
                ...
                <p className="mt-2 max-w-md text-slate-600 dark:text-slate-400">链接可能已失效，请返回仪表盘继续浏览作品展示。</p>
                <NavLink
                  to="/dashboard"
                  className="mt-8 inline-flex items-center justify-center rounded-xl bg-slate-900 px-5 py-2.5 text-sm font-medium text-white shadow-soft transition hover:bg-slate-800 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-white"
                >
                  返回仪表盘
                </NavLink>
              </div>
      ...
      <footer className="border-t border-slate-200/80 bg-white/60 py-10 backdrop-blur-sm dark:border-slate-800 dark:bg-slate-900/70">
